...
def load_data(root_path='real_data/'):
    return np.load(root_path + 'power/data.npy')
...
# a = np.load('real_data/' + 'household_power_consumption.txt',allow_pickle=True)

# df = pd.read_csv('real_data/'+'household_power_consumption.txt', sep=';', header=0, low_memory=False)