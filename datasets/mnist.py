...
class MNIST:
    ...
    class Data:
        ...
        def __init__(self, data, logit, dequantize, rng):
            ...
            self.y = utils.one_hot_encode(self.labels, 10)                  # 1-hot encoded labels
        ...
        def _logit_transform(x):
            ...
            """
            return utils.logit(MNIST.alpha + (1 - 2*MNIST.alpha) * x)
    ...
    def show_images(self, split):
        ...
        # display images
        utils.disp_imdata(data_split.x, self.image_size, [6, 10])
