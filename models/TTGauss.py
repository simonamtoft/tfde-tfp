...
class TensorTrainGaussian2D(tf.keras.Model):
    ...
    def normalize_weights(self):
        ...
        # self.Wk0 = tf.Variable(norm_Wk0, name="Wk0", dtype=tf.dtypes.float32)
        # self.Wk1k0 = tf.Variable(norm_Wk1k0, name="Wk1k0", dtype=tf.dtypes.float32)
        # self.Wk2k1 = tf.Variable(norm_Wk2k1, name="Wk2k1", dtype=tf.dtypes.float32)
        return None
